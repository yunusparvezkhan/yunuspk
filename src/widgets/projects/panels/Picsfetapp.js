...
const Picsfetapp = () => {
    ...
    return (
        <div>
            ...
            <p className='text-md text-gray-300 mb-8'>
                The purpose of building Chitro is to understand the concepts of fetching
                data from an api. This app also teaches and practices the state management
                concepts.
            </p>

            <h1 className='text-2xl mb-2' >Overview</h1>
            <p className='text-md text-gray-300 mb-8'>
                This app essentially has 2 sections. Those are the Search Feature & the
                Search Result Feature. The 2nd feature, Search Results, would not render
                at the first load of the application. It is when the user types some keywords
                and hits enter, the app sends request to the api & gets back some results.
                The app then renders the Search Results as images in a responsive grid UI.
            </p>
