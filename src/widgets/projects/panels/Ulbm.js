    ...
    return (
        <div>
            ...
            <p className='text-md text-gray-300 mb-8'>
                Ulbumy is a app that organises user datasets in a three layer level.
                Initially this app has a button to create a user, then inside the user tabs,
                it has option to create albums and inside albums it has features to create images.
                This way albums of different photos under different users can be organised.
            </p>

            <h1 className='text-2xl mb-2' >Purpose</h1>
            <p className='text-md text-gray-300 mb-8'>
                Ulbumy is a beginner project in react js to practice and learn about async
                thunks and backend data fetching methods with reduxjs store.
            </p>
            ...
            <div className='mb-8 ml-5'>
                ...
                <p className='text-md text-gray-300 mb-3 ml-5'>
                    The search feature in Ulbumy creates a user, and sends that request
                    to backend as well. Inside every user, multiple albums can be created.
                </p>

                <h2 className='text-lg font-semibold' >2. Albums Feature</h2>
                <p className='text-md text-gray-300 mb-3 ml-5'>
                    The albums feature in Ulbumy creates an album under a certain user.
                    This feature also sends that data/request to the backend as well.
                </p>

                <h2 className='text-lg font-semibold' >3. Images Feature</h2>
                <p className='text-md text-gray-300 mb-3 ml-5'>
                    The images feature in Ulbumy creates a random image under an album
                    using the faker js library. This feature too, send that data to the
                    backend.
                </p>
